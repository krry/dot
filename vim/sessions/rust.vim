" ~/.dot/vim.symlink/sessions/rust.vim:
" Vim session script.
" Created by session.vim 2.13.1 on 01 March 2019 at 22:24:38.
...
set shortmess=aoO
badd +1 THE_BOOK-notes.md
badd +5 hello_world/main.rs
argglobal
silent! argdel *
$argadd .
edit THE_BOOK-notes.md
...
wincmd w
argglobal
if bufexists("hello_world/main.rs") | buffer hello_world/main.rs | else | edit hello_world/main.rs | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
